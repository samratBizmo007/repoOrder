...
<body class="">
  ...
  <!-- <div class="w3-row w3-center w3-border-top header_bg w3-bottom w3-border-top" style="position: fixed;z-index: 3">
    <div class="w3-col s3 w3-center" style="padding:0 ">
      <a href="<?php echo base_url(); ?>user/feeds" class="btn icon"><label><i class="fa fa-home <?php if($this->uri->segment(2)=='feeds'  || $this->uri->segment(2)==''){ echo 'icon_active';}else{ echo 'w3-text-white';}?> w3-xlarge "></i></label>
      </a>
    </div>
    <div class="w3-col s3 w3-center" style="padding:0">
      <a href="<?php echo base_url(); ?>user/all_categories" class="btn icon"><label><i class="fa fa-search <?php if($record_num=='all_categories' || $this->uri->segment(2)=='category'){ echo 'icon_active';}else{ echo 'w3-text-white';}?> w3-xlarge"></i></label>
      </a>
    </div>
    <div class="w3-col s3 w3-center" style="padding:0 ">
