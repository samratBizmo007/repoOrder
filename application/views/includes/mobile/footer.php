...
<body class="">
  ...
  <div class="w3-row w3-center w3-border-top header_bg w3-bottom w3-border-top" style="position: fixed;z-index: 3">
    ...
    <div class="w3-col s4 w3-center" style="padding:0 ">
      <a href="<?php echo base_url(); ?>user/post_product" class="btn icon"><label><i class="fa fa-plus-square <?php if($record_num=='post_product'){ echo 'icon_active';}else{ echo 'w3-text-lightgrey';}?> w3-xlarge"></i></label>
      </a>
    </div>
    <div class="w3-col s2 w3-center">
      <a href="<?php echo base_url(); ?>user/add_order" class="btn icon"><label><i class="fa fa-list-alt <?php if($record_num=='add_order'){ echo 'icon_active';}else{ echo 'w3-text-lightgrey';}?> w3-xlarge"></i></label>
      </a>
    </div>
    <div class="w3-col s2 w3-center" style="padding:0 ">
      <a href="<?php echo base_url(); ?>user/profile" class="btn icon"><label><i class="fa fa-user <?php if($record_num=='profile'){ echo 'icon_active';}else{ echo 'w3-text-lightgrey';}?> w3-xlarge"></i></label>
      </a>
    </div>
  </div>
