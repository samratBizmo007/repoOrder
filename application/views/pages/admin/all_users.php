                                    ...
                                    foreach ($all_users['status_message'] as $key) {
                                        ...
                                        ?>">
                                            ...
                                            <td>
                                                ...
                                                switch ($key['status']) {
                                                    case '0':
                                                        echo '<label class="badge w3-blue" title="User Rejected">Pending</label>';
                                                        break;

                                                    case '1':
                                                        echo'<label class="badge w3-green" title="User Approved">Approved</label>';
                                                        //echo'<a class="btn w3-padding-small" onclick="deleteUser(\'' . $key['user_id'] . '\')" title="Delete Seller"><i class="w3-text-red w3-large fa fa-times-circle"></i></a>
                                                        //';
                                                        break;

                                                    case '2':
                                                        echo'<label class="badge w3-red" title="User Rejected">Rejected</label>';
                                                        break;

                                                    default:
                                                        echo'<label class="badge w3-orange" title="Value Undefined">Data Undefined</label>';
                                                        break;
                                                }
                                                ?>
                                            </td>
