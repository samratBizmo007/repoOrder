...
$(function () {
    $("#editProfileForm").submit(function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>user/Edit_profile/updateProfileNew",
            dataType : 'text',
            data: dataString,
            ...
            success: function(data){
                $.alert(data);
                $('#btnsubmit').html('<button  type="submit" id="changepass_submit" title="Change Password" class="w3-center w3-button w3-medium w3-blue" disabled><i class="fa fa-edit"></i> Update Password</button>');
            },
            error:function(data){
