      ...
      foreach ($all_salers['status_message'] as $key) { ?>
            ...
            <div class="w3-col l12 w3-card w3-round w3-margin-bottom">
              <div class="w3-col s4 w3-padding-small w3-padding-top ">
                ...
                if($key['user_image']!=''){
                ?>
                 <div class="w3-circle w3-border" style="height: 60px;width: 60px;background-position:center;background-repeat: no-repeat; background-size:contain; background-image: url('<?php echo PROFILEIMAGE_PATH.$key['user_image']; ?>');"></div>
                <?php 
              }
              else{
                ?>
                ...
                <div class="w3-col l12 w3-center w3-padding-top">
                  <a class="w3-button w3-white w3-hover-text-orange w3-hover-white" href="tel:+<?php echo $key['country_code'].$key['phone']; ?>" title="+<?php echo $key['country_code'].$key['phone']; ?>" style="margin-right: 6px;padding: 0">
