...
class Product_model extends CI_Model {
    ...
    public function addProduct($data) {
        ...
        $sql = "INSERT INTO product_tab(cat_id,user_id,product_name,prod_description,prod_image,posted_date,posted_time,isFeatured)"
                . "VALUES ('$cat_id','$user_id','".addslashes($product_name)."','".addslashes($product_description)."','$prod_images',NOW(),NOW(),'0')";
        //print_r($sql);die();
        $result = $this->db->query($sql);
        if ($result) {
            return TRUE;
