...
class Edit_profile2 extends CI_Controller {
    ...
    public function index() {
        ...
        $data['userDetails'] = Edit_profile2::getUserDetails();
        //$data['products'] = Edit_profile::getPostedImagesBy_username();
        
        $this->load->view('includes/mobile/header');
        $this->load->view('pages/user/mobile/profile/mobileedit_profile2', $data);
