...
//public function addOrederFromMobile(){
//  extract($_POST); 
//  //print_r($_POST);die();
//  $user_id=$this->session->userdata('user_id');
//  $user_name=$this->session->userdata('user_name');
...
//      if($this->upload->do_upload('userFile')){
//        $fileData = $this->upload->data();
//        $imagePath= base_url().'images/order_images/'.$fileData['file_name'];
//      }
//    }
//
//    $prod_Arr[]=array(
...
//      'prod_Name' =>  $prod_Name[$i],
//      'prod_quantity' =>  $prod_quantity[$i],
//      'prod_image' => base64_decode($imagePath),
//      'prod_regret' =>  0
//    );
//    $id_count++;
//  }
...
//  //print_r($data);die();
//  $path = base_url();
//  $url = $path.'api/ManageOrder_api/addOrederFromMobile';
//  $ch = curl_init($url);
//  curl_setopt($ch, CURLOPT_POST, true);
//  curl_setopt($ch, CURLOPT_POSTFIELDS, $data);
//  curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
