...
class Feeds extends CI_Controller {
    ...
    public function index() {
        ...
        $data['all_categories'] = Feeds::getAllCategories();
...
//-----------------fun ends here---------------------------------------------//
    ...
    //------------fun for get the all categories -----------------------//
//--------------fun for get timeline by category---------------------------// 
            public function getTimelineByCategory() {
                extract($_POST);
        //print_r($_POST);die();
                $user_id = $this->session->userdata('user_id');
                extract($_POST);
...
//--------------fun for get timeline by category ends here---------------------------// 

    //--------------fun for get timeline by search---------------------------// 
         public function getTimelineBySearch() {
            extract($_POST);
        // print_r($_POST);die();
            $user_id = $this->session->userdata('user_id');
            extract($_POST);
...
//--------------fun for get timeline by search ends here---------------------------// 
